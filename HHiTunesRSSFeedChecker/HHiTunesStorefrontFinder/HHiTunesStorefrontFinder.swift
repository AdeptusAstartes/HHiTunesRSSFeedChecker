...
open class HHiTunesStorefrontFinder: NSObject {
    
    private static let britishFormat: String = "d MMMM yyyy"
    
    static var countryData: [[String: String]] {
        return [
    ...
    static var countryCodesWithNewFeeds: [String: [String]] =
        ["recent-releases-heavy-metal": ["at", "au", "be", "bg", "ca", "ch", "cy", "cz", "de", "dk", "ee", "fi", "fr", "gr", "hu", "ie", "it", "lt", "lu", "lv", "mt", "nl", "no", "nz", "pl", "pt", "ro", "ru", "se", "si", "sk", "us", "za"],
         "new-music-heavy-metal": ["at", "au", "be", "bg", "ca", "ch", "cy", "cz", "de", "dk", "ee", "fi", "fr", "gb", "gr", "hu", "ie", "it", "lt", "lu", "lv", "mt", "nl", "no", "nz", "pl", "pt", "ro", "ru", "se", "si", "sk", "us", "za"],
         "hot-tracks-heavy-metal": ["at", "au", "be", "bg", "ca", "ch", "cy", "cz", "de", "dk", "ee", "fi", "gb", "gr", "hu", "ie", "it", "lt", "lu", "lv", "mt", "nl", "no", "nz", "pl", "pt", "ro", "ru", "se", "si", "sk", "us"]]
    

    static func storefrontId() -> String? {
        let localeToUse: Locale = Locale.current
        return HHiTunesStorefrontFinder.storefrontIdWithLocale(localeToUse)
    }
    
    static func storefrontIdWithLocale(_ locale: Locale) -> String? {
        let localeToUse: Locale = locale
        let countryCode = (localeToUse as NSLocale).object(forKey: NSLocale.Key.countryCode) as! String
        
        let filteredCountry: [String: String] = HHiTunesStorefrontFinder.countryData.filter { (country: [String: String]) in
        ...
        if let storefrontId = filteredCountry["storefrontId"] {
            return storefrontId
        }
    ...
    static func storefrontIdWithCountryCode(_ countryCode: String) -> String? {
        let filteredCountry: [String: String] = HHiTunesStorefrontFinder.countryData.filter { (country: [String: String]) in
            if (country["countryCode"] == countryCode) {
                return true
            }
    ...
    static func countryCodeWithLocale(_ locale: Locale) -> String? {
        let localeToUse: Locale = locale
        
        guard let countryCode = (localeToUse as NSLocale).object(forKey: NSLocale.Key.countryCode) as? String else {
            return nil
        }
        ...
        if let countryCodeString = filteredCountry["countryCode"] {
            return countryCodeString.lowercased()
        }
        
        return nil
    }
    
    static func releaseDateFormat() -> String {
        return HHiTunesStorefrontFinder.releaseDateFormatWithLocale(Locale.current)
    }
    
    static func releaseDateFormatWithLocale(_ locale: Locale) -> String {
        let localeToUse: Locale = locale
        ...
        if let releaseDateFormat = filteredCountry["releaseDateFormat"] {
    ...
    static func countryCodeForFeedType(feedType: HHiTunesRSSFeedCheckerFeedType) -> String? {
        if let countryCode = HHiTunesStorefrontFinder.countryCode(), let countryCodes = HHiTunesStorefrontFinder.countryCodesWithNewFeeds[feedType.rawValue] {
